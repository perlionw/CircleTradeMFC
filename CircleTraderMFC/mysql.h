...
#include "C:\Program Files (x86)\MySQL\MySQL Server 5.5\include\mysql_version.h"
#include "C:\Program Files (x86)\MySQL\MySQL Server 5.5\include\mysql_com.h"
#include "C:\Program Files (x86)\MySQL\MySQL Server 5.5\include\mysql_time.h"

#include "C:\Program Files (x86)\MySQL\MySQL Server 5.5\include\my_list.h" /* for LISTs used in 'MYSQL' and 'MYSQL_STMT' */
...
#include "C:\Program Files (x86)\MySQL\MySQL Server 5.5\include\typelib.h"
...
#include "C:\Program Files (x86)\MySQL\MySQL Server 5.5\include\my_alloc.h"
